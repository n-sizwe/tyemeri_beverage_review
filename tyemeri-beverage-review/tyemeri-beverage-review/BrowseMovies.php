			...
			<div class="container">
				<div class="row">
						...
						<div class="topnav" id="myTopnav">
							...
							<a href="BrowseMovies.php" class="active">Browse Beverages</a>
							<?php
			...
			<div class="main-search-fields">
				...
				<div class="selects-container">
					...
					<select class="selects" name="genre" >
						...
						<option Value="action">Soft Drinks</option>
						<option Value="adventure">Energy Drinks</option>
						<option Value="animation">Milk & Cream</option>
						<option Value="biography">Water</option>
						<option Value="comedy">Juices</option>
						<option Value="crime">Instant Coffee</option>
						<option Value="documentary">Whole Coffee Beans</option>
						<option Value="drama">Tea Beverages</option>
						<option Value="family">Yoghurts</option>
			            <option Value="family">Smoothies</option>
					</select>
				</div>
