		...
		<div class="row" style="background-color:black;">
			<div class="container">
				...
				<div class="topnav" id="myTopnav">
							...
							<a href="BrowseMovies.php" class="active" style="margin-left: 15px;" >Browse Beverages</a>
							<?php
...
<div class="container">
	<div class="row">
		...
		<h1 class="Moviename_header"><?php echo $row['movieName']; ?>
			<small>Beverage information</small>
		</h1>
	</div>
	<div class="row">
		<div class="detailBox">
			<div class="MovieBox">
				...
				<div class="infos">
					...
					<p>
						<span class="labelinfo">Price :</span>
					...
					<p>
						<span class="labelinfo">Brand :</span>
						<span class="Valueinfo"><?php echo $row['director']; ?></span>
					</p>
					<p>
						<span class="labelinfo">Manufacturer :</span>
						<span class="Valueinfo"><?php echo $row['cast']; ?></span>
					</p>
					<p>
						<span class="labelinfo">Ingredients :</span>
	...
	<div class="row">
		<div class="trailer">
			<h3 class="trailerHeader" style="color: #CC0066">View the Product :</h3>
