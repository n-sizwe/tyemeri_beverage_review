...
<body style="background-image: url(images/beverage.jpg); width:100% height:100%" class="img-responsive">
<!-- =====================header section=============================== -->
			...
			<div class="container">
				<div class="row">
						...
						<div class="topnav" id="myTopnav">
							...
							<a href="BrowseMovies.php" >Browse Beverages</a>
							<?php
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<div class= "modal-footer justify-content-center">
				<button type="submit" class="create" name="createAcc"> Create your BevReviews Account</button>
...
<footer class="foot">
	...
	<div class="row">
		<h6 class=" mb-0 col-12 text-center p-4 "> &copy <a href="index.html">BevReviews by Teresa Tyemeri</a></h6>							
	</div>
</footer>
