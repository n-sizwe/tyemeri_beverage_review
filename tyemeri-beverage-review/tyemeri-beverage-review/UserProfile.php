		...
		<div class="row" style="background-color:black;">
			<div class="container">
				...
				<div class="topnav" id="myTopnav">
							...
							<a href="BrowseMovies.php" style="margin-left: 15px;" >Browse Beverages</a>
							<?php
...
<!-- =====================body section=============================== -->
	<div class= "userProfile">
		<a class="userProfile-bg userProfile-block img-responsive" style="background-image: url(images/beverage.jpg);" ></a>
		<div class="container">
...
<!-- ===================== user information =============================== -->	
	<div class="container">
		...
		<h4 class="title">BEVERAGES YOU WANT TO TRY :</h4>
